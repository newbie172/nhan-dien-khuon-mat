...
def init_serial():
    ...
    ser.baudrate = 9600
    ser.bytesize = 8
    ser.port = "COM2"  # Replace with your actual COM port
    ser.timeout = 10
    ser.open()
...
class Face_Recognizer:
    ...
    def attendance(self, name):
        if name != "unknown":
            ser.write(b'a')
            print(f"{name} recognized and 'a' sent via COM port")
        else:
            ser.write(b'z')
            print(f"Unknown face or no face detected and 'z' sent via COM port")
            ...
            while stream.isOpened():
                ...
                if (self.current_frame_face_cnt == self.last_frame_face_cnt) and (
                    ...
                    if self.current_frame_face_cnt == 0:
                        ...
                        self.current_frame_face_name_list = []
                        ser.write(b'z')  # No face detected, send 'z'
                        print("No face detected and 'z' sent via COM port")
